...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText idText = (EditText)findViewById(R.id.registerEmail);
        final EditText passwordText = (EditText)findViewById(R.id.registerPassword);
        final EditText nameText = (EditText)findViewById(R.id.registerName);
        ...
        regbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent callbackIntent = new Intent(RegisterActivity.this, LoginActivity.class);

                RegisterActivity.this.startActivity(callbackIntent);
